	...
	public class ResultsBridge implements IResultsBridge 
	{
		...
		public function updateScore(_type:String):void
		{
			if (enabled)
			{
				...
				switch (_type)
				{
					case ResultsBridge.INCREASE: score = score + GlobalConfiguration.SCORE_PEANUT_VALUE; break;
					case ResultsBridge.INCREASE_SUPER: score = score + GlobalConfiguration.SCORE_PEANUT_VALUE*3; break;
