package com.boased.ui 
{
	...
	public class InterfaceStateStart extends MovieClip implements IInterfaceState
	{
		...
		private static const btnsDefY:Number = 765.45;
...
//----------------------------------------------------------------------------------------------------
		...
		private function btnClickHandler(e:MouseEvent):void 
		{
			...
			switch (e.currentTarget.name)
			{
				...
				case "btnRegulamin": navigateToURL(new URLRequest("http://horalkygames.fbmanager.pl/public/flash/kokosymlokosy/regulamin.pdf"), "_blank"); break;
			}
		}
		...
		{
			var mc:MovieClip = _currentTarget as MovieClip;
			TweenMax.to(mc, 0.3, { y:btnsDefY - 6, tint:0xee7731} );
		}
